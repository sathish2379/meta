...
def count_subarrays(arr):
  ...
  for i in range(n):
    count = 1
    right_subarray_index = i + 1
    left_subarray_index = i-1
    while right_subarray_index < n and arr[right_subarray_index] < arr[i]:
      count+=1
      right_subarray_index += 1
    
    while left_subarray_index > -1 and arr[left_subarray_index] < arr[i]:
      count+=1
